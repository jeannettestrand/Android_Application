...
public class ItemListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        System.out.println(Converters.ITEMS);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(ItemDetailFragment.ARG_ITEM_ID, item.toString() );  //.id);
                    ...
                    intent.putExtra(ItemDetailFragment.ARG_ITEM_ID, item.toString() );   //.id);
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            //holder.mIdView.setText("Hi There" );//mValues.get(position).getName() );  //id);
